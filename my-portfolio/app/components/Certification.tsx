...
export default function Certification({ title, organization, year }: CertificationProps) {
    return (
        <div className="group relative">
            ...
            <div className="relative overflow-hidden bg-gradient-to-r from-zinc-900 to-zinc-800 border border-zinc-700 p-4 rounded-xl hover:border-cyan-500 group-hover:-translate-y-1 transition-all duration-300">
                <div className="absolute top-0 right-0 w-20 h-20 bg-cyan-500/10 rounded-full blur-2xl transition-all"></div>
